openerp.base_import = function (instance) {
    ...
    instance.web.ListView.include({
        ...
        $('button.oe_list_button_import').on('click',function(e) {
    ...
    instance.web.DataImport = instance.web.Widget.extend({
        ...
        //- import itself
        call_import: function (kwargs,id) {
            ...
            return this.Import.call('do', [this.id, fields, this.import_options(), id], kwargs)
        ...
        onimport: function () {
            var self = this;
            return this.call_import({ dryrun: false },ids).done(function (message) {
