...
class ept_ent_partner(osv.osv):
    ...
    _columns = {
        'redi_id': fields.many2one('ept_ent.redis',
                    'REDI',
                    help='Redi de Ubicación'),
        'estado_id': fields.many2one('ept_ent.estados',
                    'Estado',
                    help='Estado de Ubicación'),
        'municipio_id': fields.many2one('ept_ent.municipios',
                    'Municipio',
                    help='Municipio de Ubicación'),
        'parroquia_id': fields.many2one('ept_ent.parroquias',
                    'Parroquia',
