$(document).ready(function () {
    ...
    //~ 
    $('input.ept_conf_date').mask("99-99-9999");
    
    $('input.ept_conf_date').datepicker({
        dateFormat: "dd-mm-yy"
        });
    ...
    function agregar_btn_culminacion(){
        ...
        button_declarar=$('#form1').find('button#id_guardar_rendicion_ept');
    ...
    $('tr.desplegar_avance').on('click', function(){
        ...
        $('tbody[id='+id+']').toggle("swing",function(event){});
            ...
            $('button#id_enviar_rendicion_ept').live('click', function (event){
                $('#form1').find('input[name=declarar_culminacion]').attr('value','True')
                $('button#id_guardar_rendicion_ept').click();
    ...
    $('.agregarFilaMeta').live('click', function (event){
        ...
        $("#id_guardar_rendicion_ept").click( function() {
