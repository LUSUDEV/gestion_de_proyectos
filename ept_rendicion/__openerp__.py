...
{
    'name': 'CFG Rendicion - Sistema de Plan de Inversión',
    'version': '1.0',
    'depends': ['base','base_setup','ept_cuentas','ept_conf_preguntas'],
    ...
    "data" : [
        ...
        'vistas/ept_rnd_conf_tiempo_validez_v.xml',
        'vistas/ept_rnd_cancelacion_proyectos_v .xml',
        ...
        'reportes/ept_rnd_cartas_rv.xml',
