...

{
    ...
    'update_xml': [],
    "data" : [
        'seguridad/jpv_ent_f.xml',
        'vistas/jpv_direccion/jpv_ent_redis_v.xml',
        'vistas/jpv_direccion/jpv_ent_estados_v.xml',
        'vistas/jpv_direccion/jpv_ent_municipios_v.xml',
        'vistas/jpv_direccion/jpv_ent_parroquias_v.xml',
        'vistas/jpv_entidad/jpv_ent_entidad_v.xml',
        'vistas/jpv_direccion/jpv_ent_husos_v.xml',
        'vistas/jpv_tipo_entidad/jpv_ent_tipo_entidades_v.xml',
